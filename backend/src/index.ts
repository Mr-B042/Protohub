...
import salesExpansionOrderRoutes from "./routes/sales-expansion-orders.js";
import salesExpansionRoutes from "./routes/sales-expansion.js";
...
import upsellBonusRoutes from "./routes/upsell-bonuses.js";
...
import publicAgentApplicationRoutes from "./routes/public-agent-application.js";
import customerRetentionRoutes from "./routes/customer-retention.js";
import salesLeadsRoutes from "./routes/sales-leads.js";
import managerDashboardAlertRoutes from "./routes/manager-dashboard-alerts.js";
...
import stateReplenishmentNoteRoutes from "./routes/state-replenishment-notes.js";
...
app.use("/api/sales-expansion", salesExpansionRoutes);
...
app.use("/api/manager-bonuses", managerBonusRoutes);
app.use("/api/manager-product-challenges", managerProductChallengeRoutes);
app.use("/api/delivery-goals", deliveryGoalRoutes);
app.use("/api/cash-flow", cashFlowRoutes);
app.use("/api/head-of-sales-rep", headOfSalesRepRoutes);
app.use("/api/upsell-bonuses", upsellBonusRoutes);
app.use("/api/rep-weekly-targets", repWeeklyTargetRoutes);
...
app.use("/api/public/agent-application", publicAgentApplicationRoutes);
app.use("/api/customer-retention", customerRetentionRoutes);
app.use("/api/sales-leads", salesLeadsRoutes);
app.use("/api/manager-dashboard", managerDashboardAlertRoutes);
app.use("/api/sales-bonuses", salesBonusRoutes);
...
app.use("/api/state-replenishment-notes", stateReplenishmentNoteRoutes);
