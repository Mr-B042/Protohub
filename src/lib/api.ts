...
export const followUpKpiApi = {
  ...
  log: (body: { orderId: string; text: string; channels: string[]; promisedDate?: string | null; recoveryBucket?: string | null; outcomeGroup?: string | null }) => post<any>("/api/follow-up-kpi/log", body),
